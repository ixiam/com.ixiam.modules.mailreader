...
| Last Modification Date: 2017-11-01                                 |
|                                                                    |
+--------------------------------------------------------------------+
| Copyright iXiam Global Solutions (c) 2007-2017                     |
| http://www.ixiam.com                                               |
+--------------------------------------------------------------------+
*/
...
class CRM_Mailreader_Form_Mailreader extends CRM_Core_Form {
  ...
  function buildQuickForm() {
    ...
    // Set page title
    CRM_Utils_System::setTitle(ts('Stored Mailreader'));
    ...
    $this->add('checkbox', 'show_last', ts('DESC order', array('domain' => 'com.ixiam.modules.mailreader')));
    ...
    $this->addButtons(array(
      ...
      array(
        'type' => 'submit',
        'subName' => 'export_eml',
        'name' => ts('Export to EML', array( 'domain' => 'com.ixiam.modules.mailreader')),
        'isDefault' => TRUE,
      ),*/
      array(
        'type' => 'submit',
  ...
  public function postProcess() {
    ...
    if (isset($params['_qf_Mailreader_submit_delete_all'])) {
        ...
        CRM_Utils_System::redirect(CRM_Utils_System::url('civicrm/mailreader/viewer', '&reset=1'));
    }
    ...
    if (isset($params['limit_to']) && isset($params['_qf_Mailreader_refresh_refresh'])) {
      ...
      $urlParams .= '&reset=1';
      CRM_Utils_System::redirect(CRM_Utils_System::url('civicrm/mailreader/viewer', $urlParams));
    }
